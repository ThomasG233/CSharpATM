...
namespace ATMProject
{
    public partial class ATM : Form
    {
        ...
        public void showAdditionScreen(int amountToDeduct)
        {
            clearATMScreen();
        ...
        public void logUpdateSafe(string newLog)
        {
            ...
            {
                var item = new SafeCallDelegate(logUpdateSafe);
                Management.instance.rTxtAccessLog.Invoke(item, new object[] 
                { 
                    newLog 
                });
            }
        ...
        public void updateAccountLabelSafe(string newLbl)
        {
            if (Management.instance.lblAccount[accountIndex].InvokeRequired)
            {
                ...
                Management.instance.lblAccount[accountIndex].Invoke(d, new object[] 
                { 
                    newLbl 
                });
            }
